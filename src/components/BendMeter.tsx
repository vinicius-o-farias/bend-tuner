import { BEND_TARGETS, type BendState } from '../logic/bendTracker';
...
/** Régua horizontal 0–450 cents com marcadores nos alvos e indicador da posição actual. */
export function BendMeter({ state, toleranceCents }: Props) {
